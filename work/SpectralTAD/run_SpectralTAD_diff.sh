...
/home/LiuKun/R-3.6.0/bin/Rscript SpectralTAD_run.r -i ../GM12878_downsample_diff_reso/${display_reso}k_KR_total.chr6 -o DOMAINS/diff_reso/${display_reso}k_KR_total.chr6 -r ${resolution} -c chr6
done
